        ...
        <div className='min-h-screen bg-background text-foreground'>
            <div className='max-w-screen-xl mx-auto relative'>
                <div className='lg:flex'>
                    {/* LEFT SIDE */}
                    <div className='p-8 flex flex-col items-center justify-center space-y-4 lg:fixed lg:h-screen lg:w-[400px] lg:items-start '>
                        <ProtectedImage
                        ...
                        <p className='text-muted-foreground text-center max-w-md lg:text-left '>
                            Hi there! 👋🏻
                            <br />
                            <br />
                    ...
                    {/* RIGHT SIDE */}
                    <div className='p-8 space-y-16 lg:ml-[400px] lg:flex-[3_3_0%]'>
                        <section ref={(el) => (sectionRefs.current['About Me'] = el)}>
                            <h2 className='text-2xl font-semibold mb-4'>About Me</h2>
                            <p className='text-muted-foreground mb-4'>
                                In 2022, I began experimenting with scripting, which sparked my
                                journey into coding and web development. Since then, I have built
                                and contributed to impactful projects in the fintech and startup
                                space, focusing on scalable web applications and intuitive user
                                experiences.
                            </p>
                            <p className='text-muted-foreground mb-4'>
                                ...
                                . My work involves designing and implementing solutions that
                                streamline workflows, improve efficiency, and address complex
                                business needs. With experience in both frontend and backend
                                development, I enjoy crafting full-stack solutions that bring
                                technical ideas to life in practical, impactful ways.
                            </p>
                            <p className='text-muted-foreground mb-4'>
